...
What's new ?
* New operators: FFTOperator (for complex transforms) and ConvolutionOperator (real and complex kernels) using the "pyFFTW":http://hgomersall.github.com/pyFFTW wrapper, which can also seamlessly use the MKL fft routines.
...
* Given operators A and B: A / B now translates into A * B.I. Useful when B is a scalar.
