...
This operator takes a global input and scatter it as local output. Currently only one scattering scheme is implemented: the input is split along its first dimension by equally distributing it by increasing rank.
