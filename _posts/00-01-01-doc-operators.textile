...
The @ReverseOperatorFactory@ is a convenience factory which returns a operator of the type its first argument and by swapping the attributes @attrin@(@out@), @classin@(@out@), @shapein@(@out@), @reshapein@(@out@), @toshapein@(@out@), @validatein@(@out@) from the second argument.
