...
To perform computations using an operator class, we first need to create an instance of it:
...
"Inplace operations":#inplace can be performed by providing the input array as the output.
...
The operator's data type is used for the output type determination.
TBD
