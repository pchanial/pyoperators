...
More operators can be found in the project "Tamasis/PACS":http://pchanial.github.com/tamasis-pacs, projection, discrete differences, compression, downsampling, MPI operators, etc.
