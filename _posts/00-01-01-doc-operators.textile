...
Operators can be created in two ways. The first way is to define a direct function which will replace the usual matrix-vector operation:
...
Then, an @Operator@ can be instantiated:
