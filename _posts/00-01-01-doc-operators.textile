...
An operator can propagate the class of the input array, if the latter subclasses @numpy.ndarray@:
...
An operator can also propagate attributes:
...
More flexibility is possible by passing a function, instead of a dictionary, to the @attrout@ keyword:
