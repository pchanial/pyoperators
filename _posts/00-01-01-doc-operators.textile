...
...         self.set_rule('.T', lambda s: ReverseOperatorFactory(Op2, self))
...     def direct(self, input, output):
...         output[:-1] = input
...         output[-1] = 0
...     def reshapein(self, shapein):
...
...     def __init__(self, **keywords):
...         Operator.__init__(self, **keywords)
...         self.set_rule('.T', lambda s: ReverseOperatorFactory(Op1, self))
...     def direct(self, input, output):
...         output[...] = input[:-1]
...     def reshapein(self, shapein):
...         return (shapein[0]-1,)
