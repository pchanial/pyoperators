...
h2. 2.6. <a name="operator_rules"></a> Operator's rules
...
h2. 2.7. <a name="associated_operators"></a> Operator's associated operators

Not documented. API might change in version {{ site.version_stable | plus:'0.1' }}.



h2. 2.8. <a name="operator_shapes"></a> Operator's input and output shapes
...
*implicit:* the output shape can be derived from the input shape through the method @reshapein@.
...
h2. <a name="operator_validation"></a> 2.9. Operator's input and output shape validation.
...
h2. <a name="class_propagation"></a> 2.10. Class propagation
...
h2. <a name="attribute_propagation"></a> 2.11. Attribute propagation
