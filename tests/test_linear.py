...
from pyoperators import Operator, IdentityOperator, ZeroOperator, DiagonalOperator, MaskOperator, PackOperator, UnpackOperator
...
def test_diagonal1():
    ...
    yield assert_, isinstance(3+2*d*3.*d+2*d+2, DiagonalOperator)
