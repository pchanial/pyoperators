...
class ProxyOperator(ProxyBase):
    ...
    def __init__(
        ...
        callback,
        flags,
        flags_conjugate=None,
        flags_transpose=None,
        flags_adjoint=None,
        flags_inverse=None,
        flags_inverse_conjugate=None,
        flags_inverse_transpose=None,
        flags_inverse_adjoint=None,
        **keywords,
    ):
