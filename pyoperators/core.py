...
class Operator(object):
    ...
    def __init__(self, direct=None, transpose=None, adjoint=None,
                 ...
                 shapeout=None, reshapein=None, reshapeout=None, toshapein=None,
                 toshapeout=None, validatein=None, validateout=None,
        ...
        self._init_rules()
        self._init_name()
        self._init_inout(shapein, shapeout, reshapein, reshapeout, toshapein,
    ...
    def _init_inout(self, shapein, shapeout, reshapein, reshapeout, toshapein,
        ...
        if None not in (shapeout, shapeout_) and shapeout != shapeout_:
            raise ValueError("The specified output shape '{0}' is incompatible "
                      "with the expected one '{1}'.".format(shapeout,
                      shapeout_))
