...
class FminCOBYLA(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.current_solution = opt.fmin_cobyla(
            self.criterion,
...
class FminPowell(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_powell(
            self.criterion, self.current_solution, args=self.args, **self.kwargs
        )
        # output depends on kwargs ...
        if isinstance(self.optimizer_output, tuple):
            self.current_solution = self.optimizer_output[0]
...
class FminCG(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_cg(
            self.criterion,
            self.current_solution,
...
class FminTNC(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_tnc(
            self.criterion,
            self.current_solution,
            fprime=self.gradient,
            args=self.args,
...
class FminNCG(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_ncg(
            self.criterion,
            self.current_solution,
            fprime=self.gradient,
...
class FminLBFGSB(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_l_bfgs_b(
            self.criterion,
            self.current_solution,
            fprime=self.gradient,
            args=self.args,
...
class FminSLSQP(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_slsqp(
            self.criterion,
            self.current_solution,
            fprime=self.gradient,
            args=self.args,
...
class FminBFGS(FminWrapper):
    ...
    def __call__(self):
        self.first_guess()
        self.optimizer_output = opt.fmin_bfgs(
            self.criterion,
            self.current_solution,
            fprime=self.gradient,
            args=self.args,
